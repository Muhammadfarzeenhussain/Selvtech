...
<title>Selvtech-Order Restaurant and Cafe</title>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box">
                            ...
                            <!-- <div class="breadcrumb-wrapper">
                                ...
                                <span><span>Your Order</span></span>
                            </div> -->
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                ...
                                <div class="col-lg-12">
                                    <h3 id="order_review_heading" align="center">Your order Status</h3>
                                        ...
                                        <table class="shop_table checkout-review-order-table">
                                            <thead style="">
                                                <tr class="border-0">
                                                        ...
                                                        <th class="text-dark">Food Status</th>
                                            ...
                                            <tbody>
                     <?php 
 $result=$admin->ret("select * from `order` where ouser_id='$cid' order by id DESC");
                        ...
                        {   ?>
                                ...
                                <td><?php echo $r['ogrand_total'];  ?></td>
                               
                                     <td>
                                    <?php
                                    if($r['track']=="")
                                    {?>
                                        <?php echo "Your Food is Preparing"; ?> <?php 
                                    }else {?>
                                    <?php echo $r['track'];  ?>
                                        <?php }?>
                                    </td>
                            
                                <td><a href="track.php?id=<?php echo $r['id'] ?>"><button class="btn  btn-rounded "style="background-color: #121d27"><i class="fa fa-eye"> </i></button></a></td>
...
<!-- Mirrored from themetechmount.com/html/selvtech/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 May 2022 09:22:20 GMT -->
</html>
