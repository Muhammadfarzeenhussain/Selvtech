                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="billing_country" tabindex="-1" aria-hidden="true" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea  name="order" class="form-control" rows="4"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div id="order_review" class="checkout-review-order">
                                        <table class="shop_table checkout-review-order-table">
                                            ...
                                            <tbody>
                                                <tr class="cart_item">
                                                    <td class="product-name">Mushrooms Meat&nbsp;
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-name">Royal Veg Burger&nbsp;
                                                        <strong class="product-quantity">× 1</strong>
                                                    </td>
                                                    <td class="product-total">
                                        ...
                                        <div id="payment" class="checkout-payment">
                                            <ul class="payment_methods">
                                                <li class="payment_method_ppec_paypal">
                                                    <label class="font-weight-bold">
                                                        PayPal 
                                                        <img src="images/pay-paypal-img-white.png" alt="PayPal"> 
                                                    </label>
                                            ...
                                            <div class="checkout-form place-order clearfix">
                                                ...
                                                <button type="submit" class="button ttm-btn ttm-btn-size-sm ttm-btn-bgcolor-darkgrey pull-right" name="checkout_place_order" id="place_order" value="Place order" data-value="Place order">Continue to payment</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
