...
<!-- Mirrored from themetechmount.com/html/zester/gallery-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 May 2022 09:23:36 GMT -->
<head>
<meta charset="utf-8">
...
<title>Selvtech-Gallery cafe and restaurant</title>
                        ...
                        <div class="site-header-menu-inner ttm-stickable-header">
                            <div class="container-fluid">
                                ...
                                <div class="site-branding">
                                    <a class="home-link" href="index.html" title="Selvtech" rel="gallery">
...
<?php 
$admin=new Admin();
$r=$admin->ret("select * from gallery");
while($row=$r->fetch(PDO::FETCH_ASSOC)){?>
                        <div class="col-md-4 col-sm-6">
                            <!-- featured-imagebox-event -->
                            <div class="featured-imagebox featured-imagebox-gallery style1 mb-30">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="controller/<?php echo $row['gimage'] ?>" alt="image" style="width: 350px; height: 350px">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="Autue Art Gallery Opening" href="controller/<?php echo $row['gimage'] ?>" data-rel="prettyPhoto">
...
<!-- Mirrored from themetechmount.com/html/zester/gallery-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 May 2022 09:23:40 GMT -->
</html>